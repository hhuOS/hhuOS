    ...
    switch (header.getType()) {
        ...
        default: {
            ...
            for (auto *socket: socketList) {
                ...
                auto *datagram = new Util::Network::Icmp::IcmpDatagram(datagramBuffer, payloadLength, reinterpret_cast<const Util::Network::Ip4::Ip4Address&>(information.sourceAddress), header.getType(), header.getCode());
...
void IcmpModule::writePacket(Util::Network::Icmp::IcmpHeader::Type type, uint8_t code, const Util::Network::Ip4::Ip4Address &destinationAddress, const uint8_t *buffer, uint16_t length) {
    ...
    auto &sourceInterface = Ip4::Ip4Module::writeHeader(packet, destinationAddress, Util::Network::Ip4::Ip4Header::ICMP, datagramLength);
...
void IcmpModule::sendEchoReply(const Util::Network::Ip4::Ip4Address &destinationAddress, const Util::Network::Icmp::EchoHeader &requestHeader, const uint8_t *buffer, uint16_t length, Device::Network::NetworkDevice &device) {
    auto packet = Util::Stream::ByteArrayOutputStream();
    ...
    writePacket(Util::Network::Icmp::IcmpHeader::ECHO_REPLY, 0, destinationAddress, packet.getBuffer(), packet.getLength());
}
