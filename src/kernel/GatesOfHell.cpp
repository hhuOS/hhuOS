...
#include "memory/PagingAreaManager.h"
#include "memory/PageFrameAllocator.h"
#include "memory/VirtualAddressSpace.h"
#include "service/MemoryService.h"
#include "service/InterruptService.h"
...
#include "memory/MemoryStatusNode.h"
...
#include "service/PowerManagementService.h"
...
#include "memory/PagingAreaManagerRefillRunnable.h"
...
constexpr uint32_t INITIAL_PAGING_AREA_SIZE = 256 * 1024;
constexpr uint32_t INITIAL_KERNEL_HEAP_SIZE = 128 * 1024;
...
void GatesOfHell::enter(uint32_t multibootMagic, const Kernel::Multiboot *multiboot) {
    ...
    // Ready 'shell' process
    Util::Async::Process::execute(Util::Io::File("/bin/kepler"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), "kepler", Util::Array<Util::String>(0));
    Util::Async::Process::execute(Util::Io::File("/bin/tinygl"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), "tinygl", Util::Array<Util::String>({"gears"}));
    Util::Async::Process::execute(Util::Io::File("/bin/tinygl"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), "tinygl", Util::Array<Util::String>({"cubes"}));
    Util::Async::Process::execute(Util::Io::File("/bin/wintest"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), "wintest", Util::Array<Util::String>({}));
