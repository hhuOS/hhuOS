...
void GatesOfHell::enter(uint32_t multibootMagic, const Kernel::Multiboot *multiboot) {
    ...
    Util::Async::Process::execute(Util::Io::File("/bin/tinygl"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), Util::Io::File("/device/terminal"), "tinygl", Util::Array<Util::String>({"triangle"}));
