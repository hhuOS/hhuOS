...
public:
     ...
     * Copy Constructor.
     */
    GlobalDescriptorTable(const GlobalDescriptorTable &other) = default;

    /**
     * Assignment operator.
     */
    GlobalDescriptorTable &operator=(const GlobalDescriptorTable &other) = default;
    ...
    SegmentDescriptor& getSegment(uint8_t index);
