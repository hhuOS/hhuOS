...
public:
    ...
    static Thread& createKernelProcessThread(const Util::String &name, Util::Async::Runnable *runnable);
...
private:
    ...
    static uint32_t* createKernelStack();

    static uint32_t* createUserStack();
