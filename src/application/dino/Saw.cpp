...
Saw::Saw(const Util::Math::Vector2D &position) :
        Entity(TAG, Util::Math::Vector2D(position.getX(), position.getY()), Util::Game::RectangleCollider(position, Util::Game::Collider::STATIC, 0.2, 0.2)),
        animation(Util::Array<Util::Game::Sprite>({
