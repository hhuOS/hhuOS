...
Ant::Ant(int16_t limitX, int16_t limitY) : limitX(limitX), limitY(limitY), x(static_cast<int16_t>(Util::Math::Random().getRandomNumber<float>() * limitX)), y(static_cast<int16_t>(Util::Math::Random().getRandomNumber<float>() * limitY)) {}
...
void Ant::move() {
    ...
    if (crossedBorder) {
        color = Util::Graphic::Color(static_cast<uint8_t>(random.getRandomNumber<float>() * 256), static_cast<uint8_t>(random.getRandomNumber<float>() * 256), static_cast<uint8_t>(random.getRandomNumber<float>() * 256));
    }
}
