...
bool mount(const Util::String &deviceName, const Util::String &targetPath, const Util::String &driverName) {
    return Util::System::call(Util::System::MOUNT, 3,static_cast<const char*>(deviceName),
        static_cast<const char*>(targetPath), static_cast<const char*>(driverName));
}
...
int32_t openFile(const Util::String &path) {
    ...
    const auto result = Util::System::call(Util::System::OPEN_FILE, 2,
        static_cast<const char*>(path), &fileDescriptor);
...
bool controlFileDescriptor(const int32_t fileDescriptor, const size_t request, const Util::Array<size_t> &parameters) {
    return Util::System::call(Util::System::CONTROL_FILE_DESCRIPTOR, 3,
        fileDescriptor, request, &parameters);
}
...
bool createSharedMemory(const Util::String &name, void *startAddress, const size_t pageCount) {
    return Util::System::call(Util::System::CREATE_SHARED_MEMORY, 3,
        static_cast<const char*>(name), startAddress, pageCount);
}

int32_t createSocket(const Util::Network::Socket::Type socketType) {
    int32_t fileDescriptor;
    const auto result = Util::System::call(Util::System::CREATE_SOCKET, 2,
        socketType, &fileDescriptor);
...
{
    size_t processId;
    Util::System::call(Util::System::EXECUTE_BINARY, 7,
        &binaryFile, &inputFile, &outputFile, &errorFile, &command, &arguments, &processId);
...
Util::Async::Thread createThread(const Util::String &name, Util::Async::Runnable *runnable) {
    size_t threadId;
    Util::System::call(Util::System::CREATE_THREAD, 4,
        static_cast<const char*>(name), runnable, kickoffUserThread, &threadId);
