...
#ifndef HHUOS_LIB_PULSAR_AUDIOTRACK_H
#define HHUOS_LIB_PULSAR_AUDIOTRACK_H
...
/// ## Example
/// ```c++
/// class TestScene final : public Pulsar::D2::Scene {
///
/// public:
///
/// TestScene() = default;
...
///     Pulsar::Game::getInstance().pushScene(new TestScene());
///     engine.run();
///
///     return 0;
/// }
...
public:
    ...
    explicit AudioTrack(const Util::String &waveFilePath);
