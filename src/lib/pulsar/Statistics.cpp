...
const Util::Time::Timestamp& Statistics::getLastFrameTime() const {
...
const Util::Time::Timestamp& Statistics::getLastDrawTime() const {
    if (drawTimesIndex == 0) {
        return drawTimes[0];
    }
...
const Util::Time::Timestamp& Statistics::getLastUpdateTime() const {
