...
public:
     ...
     * Constructor.
     */
    Light(uint8_t index, Type type, const Util::Math::Vector3<double> &position, const Util::Graphic::Color &diffuseColor, const Util::Graphic::Color &specularColor);
...
private:
    ...
    Util::Graphic::Color diffuseColor;
    Util::Graphic::Color specularColor;
};
