    ...
    for(traverse = format; *traverse != '\0'; traverse++) {
        ...
        switch (*traverse) {
            ...
            case 'd' :
                ...
                _nputs(strout, nmax, convert(i, 10, padding), n);
                if (n < 0) {
                    n = -1 * temp; 
                    return n;
                }
            ...
            case 'o':
                ...
                _nputs(strout, nmax, convert(i, 8, padding), n);
                if (n < 0) {
                    n = -1 * temp; 
                    return n;
                }
            ...
            case 'x':
                ...
                _nputs(strout, nmax, convert(i, 16, padding), n);
                if (n < 0) {
                    n = -1 * temp; 
                    return n;
                }
            ...
            case 'b':
                ...
                _nputs(strout, nmax, convert(i, 2, padding), n);
                if (n < 0) {
                    n = -1 * temp; 
                    return n;
                }
