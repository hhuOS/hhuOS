...
size_t VerticalLayout::getPreferredWidth(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t maxWidth = 0;
...
size_t VerticalLayout::getPreferredHeight(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t widgetHeightSum = 0;
    for (const auto &entry : widgets) {
