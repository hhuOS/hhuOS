...
public:
    /// Create a new vertical layout instance with the given spacing between widgets.
    ...
    /// This sets each widget's position below the previous widget, with the specified spacing in between.
    ...
    /// The preferred height is determined by the sum of the preferred heights of its child widgets,
