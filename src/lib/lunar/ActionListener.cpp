...
void ActionListener::onKeyPressed([[maybe_unused]] const Util::Io::Key &key) {}

void ActionListener::onKeyReleased([[maybe_unused]] const Util::Io::Key &key) {}

void ActionListener::onKeyTyped([[maybe_unused]] const Util::Io::Key &key) {}
