...
size_t HorizontalLayout::getPreferredWidth(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t widgetWidthSum = 0;
...
size_t HorizontalLayout::getPreferredHeight(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t maxHeight = 0;
    for (const auto &entry : widgets) {
