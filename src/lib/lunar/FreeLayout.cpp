...
void FreeLayout::arrangeWidgets(const Util::ArrayList<WidgetEntry> &widgets) const {
...
size_t FreeLayout::getPreferredWidth(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t maxPosX = 0;
...
size_t FreeLayout::getPreferredHeight(const Util::ArrayList<WidgetEntry> &widgets) const {
    size_t maxPosY = 0;
