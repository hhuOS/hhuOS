...
inline void enableEcho() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_ECHO, true, 0, 0);
}
...
inline void disableEcho() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_ECHO, false, 0, 0);
}
...
inline void enableLineAggregation() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_LINE_AGGREGATION,true, 0, 0);
}
...
inline void disableLineAggregation() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_LINE_AGGREGATION, false, 0, 0);
}

/// Enable the display of the cursor for the standard output.
inline void enableCursor() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_CURSOR, true, 0, 0);
}

/// Disable the display of the cursor for the standard output.
inline void disableCursor() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_CURSOR, false, 0, 0);
}
...
inline void enableAnsiParsing() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_ANSI_PARSING, true, 0, 0);
}
...
inline void disableAnsiParsing() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::SET_ANSI_PARSING, false, 0, 0);
}
...
inline void prepareGraphicalApplication(bool enableScancodes) {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::ENABLE_RAW_MODE, 0, 0, 0);

    if (enableScancodes) {
        Io::File::controlFile(Io::STANDARD_INPUT, Terminal::ENABLE_KEYBOARD_SCANCODES, 0, 0, 0);
    }
...
inline void cleanupGraphicalApplication() {
    Io::File::controlFile(Io::STANDARD_INPUT, Terminal::ENABLE_CANONICAL_MODE, 0, 0, 0);
