...
#include "lib/util/pulsar/2d/component/Component.h"
...
Entity::Entity(uint32_t tag, const Math::Vector2<double> &position) : Util::Pulsar::Entity(tag), position(position), colliderPresent(false), collider(Util::Math::Vector2<double>(0, 0), Util::Math::Vector2<double>(0, 0), Collider::STATIC) {}

Entity::Entity(uint32_t tag, const Math::Vector2<double> &position, const RectangleCollider &collider) : Util::Pulsar::Entity(tag), position(position), colliderPresent(true), collider(collider) {}
