...
#include "lib/util/io/stream/Writer.h"
...
void PrintWriter::write(const String &string) {
    write(string, 0, string.length());
}

void PrintWriter::write(const String &string, uint32_t offset, uint32_t length) {
...
void PrintWriter::print(const String &string) {
    writer.write(string);
}
...
void PrintWriter::print(uint32_t number) {
    ...
    auto numberWriter = Io::PrintWriter(numberStream);
...
void PrintWriter::println(const String &string) {
    print(string);
    println();
}
...
PrintWriter &PrintWriter::operator<<(const String &string) {
    print(string);
    return *this;
}
