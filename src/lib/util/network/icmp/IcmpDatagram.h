...
///     Util::System::out << "Failed to send ICMP Echo Request!" << Util::Io::PrintStream::lnFlush;
///     return;
/// }
///
...
///     Util::System::out << "Failed to receive ICMP Echo Reply!" << Util::Io::PrintStream::lnFlush;
///         return;
///     }
///
