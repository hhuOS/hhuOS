...
extern void putDebugChar(char value);	/* write a single character      */
extern char getDebugChar();	/* read and return a single char */
extern void exceptionHandler(unsigned int number, void(*)());	/* assign an exception handler   */
 ...
 */
void
_handle_exception (int exceptionVector)
{
  int sigval, stepping;
  int addr, length;
  char *ptr;
