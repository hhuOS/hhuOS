 ...
 */
class LfbText : public TextDriver, private LinearFrameBuffer {

private:

    static const constexpr char *NAME = "LfbText";
...
public:
     ...
     * Constructor.
     */
    LfbText(void *address, uint16_t xres, uint16_t yres, uint8_t bpp, uint16_t pitch);

    /**
     * Copy-constructor.
     */
    LfbText(LfbText &copy) = delete;

    /**
     * Destructor.
     */
    ~LfbText() override = default;
