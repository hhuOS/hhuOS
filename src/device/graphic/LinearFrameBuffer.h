...
public:
    ...
    struct LfbResolution {
        ...
        bool operator==(const LfbResolution &other) const {
            return resX == other.resX && resY == other.resY && depth == other.depth && modeNumber == other.modeNumber;
        }
     ...
     */
    virtual Util::String getVendorName();

    /**
     * Get the device's name.
     * Return "Unknown", if the name is not known.
     */
    virtual Util::String getDeviceName();
     ...
     */
    virtual void drawPixel(uint16_t x, uint16_t y, Util::Color color);
     ...
     */
    virtual void readPixel(uint16_t x, uint16_t y, Util::Color &color);
     ...
     * @param color The color
     */
    virtual void drawLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, Util::Color color);
     ...
     * @param color The color
     */
    virtual void drawRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, Util::Color color);
     ...
     * @param color The color
     */
    virtual void fillRect(uint16_t x1, uint16_t y1, uint16_t width, uint16_t height, Util::Color color);
     ...
     * @param color The color
     */
    virtual void fillCircle(uint16_t x, uint16_t y, uint16_t radius, Util::Color color);
     ...
     * @param c The char
     */
    virtual void drawChar(const Util::Font &font, uint16_t x, uint16_t y, char c, Util::Color fgColor, Util::Color bgColor);
     ...
     * @param s The string
     */
    virtual void drawString(const Util::Font &font, uint16_t x, uint16_t y, const char *s, Util::Color fgColor, Util::Color bgColor);
     ...
     * @param color The color
     */
    void placeLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, Util::Color color);
     ...
     * @param color The color
     */
    void placeRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, Util::Color color);
     ...
     * @param color The color
     */
    void placeFilledRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, Util::Color color);
     ...
     * @param color The color
     */
    void placeFilledCircle(uint16_t x, uint16_t y, uint16_t radius, Util::Color color);
     ...
     * @param s The string
     */
    void placeString(Util::Font &font, uint16_t x, uint16_t y, const char *s, Util::Color fgColor, Util::Color bgColor = Util::Colors::INVISIBLE);
     ...
     * @param data The sprite-data
     */
    void placeSprite(uint16_t x, uint16_t y, uint16_t width, uint16_t height, int32_t *data);
...
private:
     ...
     * An implementation must not set the variables resolutionX, resolutionY and bitsPerPixel! This will be done automatically by init()!
     *
...
private:
    /**
     * Draw a monochrome bitmap at a given position.
     *
     * @param x The x-coordinate
     * @param y The y-coordinate
     ...
     */
    void drawMonoBitmap(uint16_t x, uint16_t y, uint16_t width, uint16_t height, Util::Color fgColor, Util::Color bgColor, uint8_t *bitmap);
