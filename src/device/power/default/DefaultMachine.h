...
private:
    ...
    const IoPort qemuShutdownPort;
    const IoPort keyboardControlPort;

    static const constexpr uint16_t QEMU_DEBUG_EXIT_PORT = 0x501;
    static const constexpr uint16_t KEYBOARD_CONTROL_PORT = 0x64;
