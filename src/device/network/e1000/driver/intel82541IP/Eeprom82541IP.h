...
#ifndef HHUOS_EEPROM82541IP_H
#define HHUOS_EEPROM82541IP_H


#include "device/network/e1000/eeprom/ErDefault.h"
 ...
 */
class Eeprom82541IP final : public ErDefault {
public:
    /**
     * Constructor. Same as in extended class.
     */
    explicit Eeprom82541IP(Register *request);
    ~Eeprom82541IP() override = default;
