...
Util::Data::HashMap<Memory::String, Prototype*> Prototype::prototypeTable;

Prototype* Prototype::createInstance(Memory::String &type) {
    Memory::String key = type.toLowerCase();
...
void Prototype::registerPrototype(Prototype *prototype) {
    Memory::String key = prototype->getTypeName().toLowerCase();

    prototypeTable.put(key, prototype);
}

void Prototype::deregisterPrototype(const Memory::String &type) {
