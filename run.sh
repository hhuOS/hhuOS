...
readonly CONST_QEMU_CPU_I386="base,+fpu,+tsc,+cmov,+fxsr,+mmx,+sse,+sse2,+sep,+apic"
readonly CONST_QEMU_DEFAULT_RAM="128M"
readonly CONST_QEMU_BIOS_PC=""
readonly CONST_QEMU_BIOS_EFI="RELEASEIa32_OVMF.fd"

readonly CONST_QEMU_ARGS="-vga std -serial stdio -rtc base=localtime -device isa-debug-exit -smp 2 -display sdl"
